...
export const DOWNLOAD_KEYINS_BRANCHES_TEMPLATE = 'downloadKeyinsBranchesTemplate'
...
export const DOWNLOAD_KEYINS_PERSONS_TEMPLATE = 'downloadKeyinsPersonsTemplate'
...
export const IT_DATABASE_DETAILS = 'ITDatabaseDetails'
...
//IT/DbBackupPlans
export const INIT_IT_DBBACKUPPLANS = 'initITDbBackupPlans'
export const FETCH_IT_DBBACKUPPLANS = 'fetchITDbBackupPlans'
export const CREATE_IT_DBBACKUPPLAN = 'createITDbBackupPlan'
export const STORE_IT_DBBACKUPPLAN = 'storeITDbBackupPlan'
export const IT_DBBACKUPPLAN_DETAILS = 'ITDbBackupPlanDetails'
export const EDIT_IT_DBBACKUPPLAN = 'editITDbBackupPlan'
export const UPDATE_IT_DBBACKUPPLAN = 'updateITDbBackupPlan'
export const REMOVE_IT_DBBACKUPPLAN = 'removeITDbBackupPlan'
//IT/SystemApps
...
export const IT_SYSTEM_APP_DETAILS = 'itSystemAppDetails'
